...
import { MessagesPrescriptionPageModule } from './messages-prescription/messages-prescription.module';
...
@NgModule({
    ...
    imports: [
        ...
        prescriptionDrugAddModule, prescriptionDrugEditModule, prescriptionListModule, 
        prescriptionAddStep2Module,medicationAllergyModule,healthConditionModule,
        prescriptionItemEditModule,filterhModule,MessagesPrescriptionPageModule
    ],
})

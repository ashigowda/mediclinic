...
import { MessagesTaskPageModule } from './messages-task/messages-task.module';
...
@NgModule({
  ...
  imports: [
    ...
    appointmentAddStep2Module, contactSearchModule, appointmentEditModule,
    invoiceDetailsModule,invoiceAddModule,searchSymptomModule,MessagesTaskPageModule
  ],
})

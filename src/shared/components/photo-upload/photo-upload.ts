...
export class Photoupload {
  ...
  fileChangeEvent(event: any): void {
    console.log("fileChangeEvent Event triggered")
    console.log(JSON.stringify(event));
    this.imageChangedEvent = event;
  }
  imageCropped(image: string) {
    console.log("imageCropped event triggered")
  ...
  loadImageFailed() {
    console.log("loadImageFailed event triggered")
    // show message
  }
